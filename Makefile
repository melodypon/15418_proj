all:	efb_serial efb_openmp efb_mpi efb_cuda goss_serial goss_openmp goss_mpi goss_cuda
...
efb_cuda:	efb_cuda_main.o efb_cuda_cuda.o
	g++ -m64 -O3 -Wall -o efb_cuda efb_cuda_main.o efb_cuda_cuda.o -L/usr/local/cuda-11.7/lib64/ -lcudart -lcurand 

efb_cuda_main.o:	efb_cuda.cpp
	g++ -m64 efb_cuda.cpp -O3 -Wall -c -o efb_cuda_main.o

efb_cuda_cuda.o:	efb_cuda.cu
	nvcc -O3 -m64 efb_cuda.cu --gpu-architecture compute_61 -ccbin /usr/bin/gcc -c -o efb_cuda_cuda.o
...
clean:
	$(RM) efb_serial efb_openmp efb_mpi efb_cuda goss_serial goss_openmp goss_mpi goss_cuda